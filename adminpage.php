...
<form>
<div align="right">
<a href="userlogin.php"><input type="button" value="LOGOUT" onclick="return confirm('ARE YOU SURE WANT TO LOGOUT?')"></a>
</div>
</form>
...
<nav>
  <ul class="nav">
    ...
    <li><a href="deactivate.php">DEACTIVATE ACCOUNTS</a></li> 
